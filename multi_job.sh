...
mkdir $path/results/halfcheetah_medium_expert/
...
cp ./tmp/${SLURM_ARRAY_TASK_ID}.txt $path/results/halfcheetah_medium_expert/
...
cp ./tmp/${SECOND_SEED}.txt $path/results/halfcheetah_medium_expert/